...
def check_img_size(imgsz, s=32, floor=0):
    ...
    if new_size != imgsz:
        LOGGER.warning(f'WARNING ⚠️ --images-size {imgsz} must be multiple of max stride {s}, updating to {new_size}')
    return new_size
...
def non_max_suppression(
    ...
    multi_label &= nc > 1  # multiple labels per box (adds 0.5ms/images)
